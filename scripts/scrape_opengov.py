...
JURISDICTIONS = [
    ...
    # ── Restored 2026-05-26: 104 portals dropped from JURISDICTIONS between
    # 2026-05-12 and 2026-05-13 (likely an accidental edit). Re-adding them
    # is the root-cause fix for the "97 OpenGov zombie sources" wave. All
    # API endpoints verified live during the 2026-05-26 fix.
    # Discovered 2026-04-09
    {"id": "conroetx",           "name": "Conroe",                "state": "TX"},
    {"id": "losangelesca",       "name": "Los Angeles",           "state": "CA"},
    {"id": "richmondcountyva",   "name": "Richmond County",      "state": "VA"},
    {"id": "philadelphiapa",     "name": "Philadelphia",          "state": "PA"},
    {"id": "fortmyersfl",        "name": "Fort Myers",            "state": "FL"},
    {"id": "kansascitymo",       "name": "Kansas City",           "state": "MO"},
    {"id": "sanfranciscoca",     "name": "San Francisco",         "state": "CA"},
    {"id": "orangecountyca",     "name": "Orange County",         "state": "CA"},
    {"id": "indianapolisin",     "name": "Indianapolis",          "state": "IN"},
    {"id": "rochesterny",        "name": "Rochester",             "state": "NY"},
    {"id": "fresnoca",           "name": "Fresno",                "state": "CA"},
    {"id": "phoenixaz",          "name": "Phoenix",               "state": "AZ"},
    {"id": "oaklandca",          "name": "Oakland",               "state": "CA"},
    {"id": "corpuschristitx",    "name": "Corpus Christi",        "state": "TX"},
    {"id": "harriscountytx",     "name": "Harris County",         "state": "TX"},
    {"id": "austintx",           "name": "Austin",                "state": "TX"},
    # Discovered 2026-04-09 batch 2 (~1.9M records)
    {"id": "walpolema",                "name": "Walpole",                       "state": "MA"},
    {"id": "haverhillma",              "name": "Haverhill",                     "state": "MA"},
    {"id": "portsmouthnh",             "name": "Portsmouth",                    "state": "NH"},
    {"id": "boltonct",                 "name": "Bolton",                        "state": "CT"},
    {"id": "nortonma",                 "name": "Norton",                        "state": "MA"},
    {"id": "monroect",                 "name": "Monroe",                        "state": "CT"},
    {"id": "salisburyct",              "name": "Salisbury",                     "state": "CT"},
    {"id": "granbyny",                 "name": "Granby",                        "state": "NY"},
    {"id": "coventryct",               "name": "Coventry",                      "state": "CT"},
    {"id": "winchesterva",             "name": "Winchester",                    "state": "VA"},
    {"id": "mansfieldtx",              "name": "Mansfield",                     "state": "TX"},
    {"id": "portsmouthri",             "name": "Portsmouth",                    "state": "RI"},
    {"id": "milfordct",                "name": "Milford",                       "state": "CT"},
    {"id": "madisonin",                "name": "Madison",                       "state": "IN"},
    {"id": "berlinma",                 "name": "Berlin",                        "state": "MA"},
    {"id": "graftonma",                "name": "Grafton",                       "state": "MA"},
    {"id": "dracutma",                 "name": "Dracut",                        "state": "MA"},
    {"id": "burlingtonvt",             "name": "Burlington",                    "state": "VT"},
    {"id": "hopkintonma",              "name": "Hopkinton",                     "state": "MA"},
    {"id": "chelseama",                "name": "Chelsea",                       "state": "MA"},
    {"id": "winthropma",               "name": "Winthrop",                      "state": "MA"},
    {"id": "doverma",                  "name": "Dover",                         "state": "MA"},
    {"id": "wellesleyma",              "name": "Wellesley",                     "state": "MA"},
    {"id": "enfieldct",                "name": "Enfield",                       "state": "CT"},
    {"id": "townofessexma",            "name": "Essex",                         "state": "MA"},
    {"id": "brooklinema",              "name": "Brookline",                     "state": "MA"},
    {"id": "manchesterma",             "name": "Manchester",                    "state": "MA"},
    {"id": "yarmouthma",               "name": "Yarmouth",                      "state": "MA"},
    {"id": "salemnh",                  "name": "Salem",                         "state": "NH"},
    {"id": "kingstonma",               "name": "Kingston",                      "state": "MA"},
    {"id": "windsorct",                "name": "Windsor",                       "state": "CT"},
    {"id": "hopkintonri",              "name": "Hopkinton",                     "state": "RI"},
    {"id": "warrenri",                 "name": "Warren",                        "state": "RI"},
    {"id": "boltonma",                 "name": "Bolton",                        "state": "MA"},
    {"id": "cromwellct",               "name": "Cromwell",                      "state": "CT"},
    {"id": "marshfieldma",             "name": "Marshfield",                    "state": "MA"},
    {"id": "winchesterma",             "name": "Winchester",                    "state": "MA"},
    {"id": "darienil",                 "name": "Darien",                        "state": "IL"},
    {"id": "raynhamma",                "name": "Raynham",                       "state": "MA"},
    {"id": "exeterri",                 "name": "Exeter",                        "state": "RI"},
    {"id": "meridenct",                "name": "Meriden",                       "state": "CT"},
    {"id": "plainvillema",             "name": "Plainville",                    "state": "MA"},
    {"id": "atlantaga",          "name": "Atlanta",               "state": "GA"},
    # Discovered 2026-04-10 (sitemap + brute force)
    {"id": "andoverma",                   "name": "Andover",                     "state": "MA"},
    {"id": "jacksontn",                   "name": "Jackson",                     "state": "TN"},
    {"id": "franklinma",                  "name": "Franklin",                    "state": "MA"},
    {"id": "northandoverma",              "name": "Northandover",                "state": "MA"},
    {"id": "puebloco",                    "name": "Pueblo",                      "state": "CO"},
    {"id": "brightonny",                  "name": "Brighton",                    "state": "NY"},
    {"id": "agawamma",                    "name": "Agawam",                      "state": "MA"},
    {"id": "dedhamma",                    "name": "Dedham",                      "state": "MA"},
    {"id": "plymouthma",                  "name": "Plymouth",                    "state": "MA"},
    {"id": "kernersvillenc",              "name": "Kernersville",                "state": "NC"},
    {"id": "granburytx",                  "name": "Granbury",                    "state": "TX"},
    {"id": "boardmanoh",                  "name": "Boardman",                    "state": "OH"},
    {"id": "vestaviahillsal",             "name": "Vestaviahills",               "state": "AL"},
    {"id": "ithacany",                    "name": "Ithaca",                      "state": "NY"},
    {"id": "cypressca",                   "name": "Cypress",                     "state": "CA"},
    {"id": "northsmithfieldri",           "name": "Northsmithfield",             "state": "RI"},
    {"id": "lakevillema",                 "name": "Lakeville",                   "state": "MA"},
    {"id": "gilpincountyco",              "name": "Gilpin",                      "state": "CO"},
    {"id": "goldenco",                    "name": "Golden",                      "state": "CO"},
    {"id": "claremoreok",                 "name": "Claremore",                   "state": "OK"},
    {"id": "binghamcountyid",             "name": "Bingham",                     "state": "ID"},
    {"id": "cloverdaleca",                "name": "Cloverdale",                  "state": "CA"},
    {"id": "blackfootid",                 "name": "Blackfoot",                   "state": "ID"},
    {"id": "breckenridgeco",              "name": "Breckenridge",                "state": "CO"},
    {"id": "arvinca",                     "name": "Arvin",                       "state": "CA"},
    {"id": "adamscountyco",               "name": "Adams",                       "state": "CO"},
    {"id": "columbusin",                  "name": "Columbus",                    "state": "IN"},
    {"id": "chilmarkma",                  "name": "Chilmark",                    "state": "MA"},
    {"id": "cityofaspenco",               "name": "Aspen",                       "state": "CO"},
    {"id": "lawrenceks",                  "name": "Lawrence",                    "state": "KS"},
    {"id": "pascocountyfl",               "name": "Pasco",                       "state": "FL"},
    {"id": "burlingtonia",                "name": "Burlington",                  "state": "IA"},
    {"id": "windsorco",                   "name": "Windsor",                     "state": "CO"},
    {"id": "bouldercountyco",             "name": "Boulder",                     "state": "CO"},
    {"id": "altoonapa",                   "name": "Altoona",                     "state": "PA"},
    {"id": "danvilleva",                  "name": "Danville",                    "state": "VA"},
    {"id": "roswellga",                   "name": "Roswell",                     "state": "GA"},
    {"id": "bishopca",                    "name": "Bishop",                      "state": "CA"},
    {"id": "newcastlewa",                 "name": "Newcastle",                   "state": "WA"},
    {"id": "northlaketx",                 "name": "Northlake",                   "state": "TX"},
    {"id": "clintonma",                   "name": "Clinton",                     "state": "MA"},
    {"id": "countyoffrederickmd",         "name": "Frederick",                   "state": "MD"},
    {"id": "caycesc",                     "name": "Cayce",                       "state": "SC"},
    {"id": "dyersburgtn",                 "name": "Dyersburg",                   "state": "TN"},
    {"id": "beavertonor",                 "name": "Beaverton",                   "state": "OR"},
